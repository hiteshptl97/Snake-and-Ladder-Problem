...
public class Ensureplayergetsexactwinposition {
    Ensureplayergetsexactwinposition() {System.out.println("Welcome to Snake and Ladder Simulation \n");}

        public static void main(String[] args) {
            Ensureplayergetsexactwinposition a = new  Ensureplayergetsexactwinposition();

...
public class NodieRollAndPosition {
    NodieRollAndPosition() {System.out.println("Welcome to Snake and Ladder Simulation \n");}

        public static void main(String[] args) {
            NodieRollAndPosition a = new NodieRollAndPosition();
